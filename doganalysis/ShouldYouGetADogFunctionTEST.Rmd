...
# Create test set, each column representing a specific user's inputs
...
# For each user in test set, generate their inputs 
for (i in 1:N) {
...
# for each user in test set, calculate their "should you get a dog?" score
 for (i in 1:N) { 
...
## Analyze Results
```{r}
# Plot distribution scores for all users in test set
